...
SELECT * FROM ATTENDANCE;
 + (INTERVAL '1' YEAR) 
SELECT ROUND((TO_DATE('20180101', 'YYYYMMDD') - TO_DATE(A.EM_JOIN, 'YYYYMMDD') + 1) / 30) AS 2017_연차
ROUND((TO_DATE('20190101', 'YYYYMMDD') - TO_DATE(A.EM_JOIN, 'YYYYMMDD') + 1) / 30) AS 2018_연차
ROUND((TO_DATE('20200101', 'YYYYMMDD') - TO_DATE(A.EM_JOIN, 'YYYYMMDD') + 1) / 30) AS 2019_연차
ROUND((TO_DATE('20210101', 'YYYYMMDD') - TO_DATE(A.EM_JOIN, 'YYYYMMDD') + 1) / 30) AS 2020_연차
ROUND((TO_DATE('20220101', 'YYYYMMDD') - TO_DATE(A.EM_JOIN, 'YYYYMMDD') + 1) / 30) AS 2021_연차
ROUND((TO_DATE('20230101', 'YYYYMMDD') - TO_DATE(A.EM_JOIN, 'YYYYMMDD') + 1) / 30) AS 2022_연차
ROUND((TO_DATE('20230901', 'YYYYMMDD') - TO_DATE(A.EM_JOIN, 'YYYYMMDD') + 1) / 30) AS 2023_연차
FROM EMPLOYEE A
